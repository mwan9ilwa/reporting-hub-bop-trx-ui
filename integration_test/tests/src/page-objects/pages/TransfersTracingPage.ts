...
export const FindTransfersPage = {
  ...
  transferStateFilterField: Selector('.placeholder').withText('Transfer State').sibling('.rc-select'),
  ...
  getTransferDetailsModal: (transferId: string) => Selector('.rc-modal__header__title')
